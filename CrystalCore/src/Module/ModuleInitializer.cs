...
internal static class ModuleInitializer
{
    ...
    public static void Initialize()
    {
        ...
        harmony = createMethod.Invoke(null, new object[] { "com." + nameof(CrystalCore.CrystalCore).ToLower() + ".nickc01" });
        ...
        patchAll.Invoke(harmony, new object[] { typeof(CrystalCore.CrystalCore).Assembly });

        Logger.Log("Loaded CrystalCore Backend. Load Info : " + LoadInfo);
        //CrystalCore.Internal.ActionDataLoader.Start();
    }
    ...
    static void OnNewAssembly(Assembly assembly, bool justStarted)
    {
        ...
        {
            Modding.Logger.LogError($"Failed to get CrystalCore attributes for the following assembly: {assembly.FullName}. Exception Details -> " + e);
        }
    }
