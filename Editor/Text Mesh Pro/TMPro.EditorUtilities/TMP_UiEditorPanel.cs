...
namespace TMPro.EditorUtilities
{
	...
	public class TMP_UiEditorPanel : Editor
	{
		...
		public void OnEnable()
		{
			...
			raycastTarget_prop = base.serializedObject.FindProperty("m_RaycastTarget");
			...
			m_textComponent = (base.target as TextMeshProUGUI);
		...
		public override void OnInspectorGUI()
		{
			...
			if (m_foldout.fontSettings)
			{
				...
				{
					EditorGUI.BeginChangeCheck();
					controlRect = EditorGUILayout.GetControlRect(false, 17f);
				...
				selAlignGrid_A = GUI.SelectionGrid(new Rect(num9, controlRect.y, 138f, controlRect.height), selAlignGrid_A, TMP_UIStyleManager.alignContent_A, 4, gUIStyle);
			...
			if (m_foldout.extraSettings)
			{
				...
				if (EditorGUI.EndChangeCheck())
				{
					Graphic[] componentsInChildren = ((Component)(object)m_textComponent).GetComponentsInChildren<Graphic>();
					for (int k = 0; k < componentsInChildren.Length; k++)
					{
						componentsInChildren[k].raycastTarget = raycastTarget_prop.boolValue;
					}
					havePropertiesChanged = true;
				}
				EditorGUILayout.EndHorizontal();
		...
		private bool IsMixSelectionTypes()
		{
			...
			if (gameObjects.Length > 1)
			{
				...
				{
					if ((UnityEngine.Object)(object)((GameObject)gameObjects[i]).GetComponent<TextMeshProUGUI>() == null)
					{
						return true;
					}
				}
