    ...
    public class TMP_UiEditorPanel : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (toggleStyle == null)
            {
                ...
                Debug.Log("Section Label = " + TMP_UIStyleManager.Section_Label);
                Debug.Log("Normal = " + TMP_UIStyleManager.Section_Label.normal);
                Debug.Log("Text Color = " + TMP_UIStyleManager.Section_Label.normal.textColor);
