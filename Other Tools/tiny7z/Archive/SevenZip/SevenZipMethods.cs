...
namespace pdj.tiny7z.Archive
{
    public static class SevenZipMethods
    {
        ...
        public static readonly Dictionary<MethodID, Compression.Registry7Zip.Method> Supported;
        public static readonly Dictionary<Compression.Registry7Zip.Method, MethodID> Lookup;
        ...
        static SevenZipMethods()
        {
            try
            {
                ...
                Supported = new Dictionary<MethodID, Compression.Registry7Zip.Method>
                {
                    { new MethodID( 0x00 ), Compression.Registry7Zip.Method.Copy },
                    { new MethodID( 0x21 ), Compression.Registry7Zip.Method.LZMA2 },
                    { new MethodID( 0x03, 0x01, 0x01 ), Compression.Registry7Zip.Method.LZMA },
                    { new MethodID( 0x03, 0x03, 0x01, 0x03 ), Compression.Registry7Zip.Method.BCJ },
                    { new MethodID( 0x03, 0x03, 0x01, 0x1B ), Compression.Registry7Zip.Method.BCJ2 },
                    { new MethodID( 0x03, 0x04, 0x01 ), Compression.Registry7Zip.Method.PPMd },
                    { new MethodID( 0x04, 0x01, 0x08 ), Compression.Registry7Zip.Method.Deflate },
                    { new MethodID( 0x04, 0x02, 0x02 ), Compression.Registry7Zip.Method.BZip2 },
                    { new MethodID( 0x06, 0xF1, 0x07, 0x01 ), Compression.Registry7Zip.Method.AES },
                };
