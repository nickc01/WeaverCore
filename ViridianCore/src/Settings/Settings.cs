...
namespace ViridianCore
{
    ...
    /// <summary>
    /// Settings used to control the behaviour of ViridianCore, such as turning on debug mode or enabling gameObject tracking
    /// </summary>
    public static class Settings
    {
        static bool started = false;

        internal class SettingsStart : IHook<ViridianCore>
        {
