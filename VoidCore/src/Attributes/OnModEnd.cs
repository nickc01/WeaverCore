...
{
    /// <summary>
    /// When added onto a static method, that method will be called when a mod is unloaded
    /// </summary>
    [System.AttributeUsage(AttributeTargets.Method, Inherited = false, AllowMultiple = true)]
    internal sealed class ModEndAttribute : Attribute
    {
        /// <summary>
        ...
        public ModEndAttribute(Type type = null)
        {
