...
namespace DependenciesHunter
{
    ...
    public class AllProjectAssetsReferencesWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            {
                var assets = filteredAssets.Select(fa => AssetDatabase.LoadMainAssetAtPath(fa.Path));
    ...
    public class ProjectAssetsAnalysisUtilities
    {
        ...
        public bool IsValidAssetType(string path, bool validForOutput)
        {
            ...
            if (!string.IsNullOrEmpty(importer.assetBundleName) || path.Contains("WeaverCore/WeaverCore.Editor/"))
            {
                return false;
            }
