...
namespace WeaverCore.Editor.Settings
{
    ...
    public sealed class SettingsScreen : MonoBehaviour
    {
        ...
        static void Init()
        {
            prefab = EditorAssets.LoadEditorAsset<GameObject>("Weaver Settings Screen").GetComponent<SettingsScreen>();
        ...
        static void SpawnMenu()
        {
            if (Instance == null)
            {
                Instance = Instantiate(prefab, WeaverDebugCanvas.Content);
        ...
        internal void SelectTab(Tab tab)
        {
            ...
            //AddDefaultElements(tab.Panel);

            tab.Panel.OnPanelOpen();
        }

        /*void AddDefaultElements(Panel panel)
        {
        ...
        {
            var newElement = Instantiate(prefab, elementContainer);
        ...
        /// <returns></returns>
        internal static bool MemberIsUsable(MemberInfo memberInfo, out SettingFieldAttribute attribute)
        {
