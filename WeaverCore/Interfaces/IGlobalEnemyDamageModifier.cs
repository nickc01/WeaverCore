...
namespace WeaverCore.Interfaces
{
    ...
    public interface IGlobalEnemyDamageModifier
    {
        ...
        void OnHit(GameObject attacker, GameObject go, ref AttackTypes attackType, ref int damage, ref float direction, ref bool ignoreInvincible, ref float attackStrength);
    }
}
