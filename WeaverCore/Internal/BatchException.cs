...
namespace WeaverCore.Internal
{
    ...
    {
        private IEnumerable<Exception> m_innerExceptions;
        ...
        public AggregateException(string message, Exception innerException) : base(message, innerException)
        {
            ...
            m_innerExceptions = new Exception[] { innerException };
        }
        ...
        public AggregateException(string message, params Exception[] innerExceptions) : this(message)
        {
            m_innerExceptions = innerExceptions;
        }
	...
	public class BatchException : Exception
	{
		...
		public BatchException(IEnumerable<Exception> Exceptions)
		{
        ...
        public BatchException(string message, IEnumerable<Exception> innerExceptions) : base(message)
        {
