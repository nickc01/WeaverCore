...
{
	/*public abstract class ClassWidePatcher<ClassToPatch> : ClassWidePatcher
	{
	...
	public abstract class ClassWidePatcher
	{
		...
		static MethodInfo GetStaticMethod(Type type, string name, bool caseSensitive = true)
		{
