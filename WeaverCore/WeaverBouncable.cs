...
{
    public class WeaverBouncable : MonoBehaviour
    {
        ...
        private void OnCollisionEnter2D(Collision2D col)
        {
            ...
            if (playAnimationOnBounce && animTimer <= 0f && animator.HasAnimationClip(animationName))
            {
            ...
            if (sendFSMEvent)
            {
                EventManager.SendEventToGameObject("BOUNCE", gameObject);
